...
<Aside variant="tip">The script has already been updated to create more stable and diff-able json files with jq, and there might be more changes in its future. Make sure to visit the above link to grab any changes.</Aside>
